...
$_['entry_default_price_mods'] = 'Значения опций "по умолчанию" должны быть указаны с помощью модуля Расширенные опции 3.';
...
$_['text_relatedoptions_notify'] = 'Должен быть установлен модуль Связанные опции или Связанные опции PRO';
$_['text_relatedoptions_pro_notify'] = 'Должен быть установлен модуль: Связанные опции PRO';
