<?php
class ControllerProductLatests extends Controller {
	public function index() {
		$this->load->language('product/latests');
		...
		$product_total = $this->model_catalog_product->getTotalLatests();

		$results = $this->model_catalog_product->getLatests($filter_data);
		...
		$pagination->url = $this->url->link('product/latests', $url . '&page={page}');
